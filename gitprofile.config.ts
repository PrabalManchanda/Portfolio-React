const CONFIG= {
    ...
    social: {
      ...
      dribbble: '',
      behance: '',
      medium: 'PrabalManchanda',
      dev: '',
      website: '',
      phone: '+1(647) 530-0715',
      email: 'prabalmanchanda10@email.com',
    },
    resume: {
    ...
    projects: {
      github: {
        ...
        manual: {
            projects: [
              'PrabalManchanda/My-Portfolio',
              'PrabalManchanda/Portfolio-Builder',
              'rishabhworks/The-Semicolon-Squad',
              'PrabalManchanda/Scrabble',
              'PrabalManchanda/Portfolio-React',
              'PrabalManchanda/Rock-Paper-Scissors',
              'PrabalManchanda/Book-Website',
              'PrabalManchanda/Fitness',
              'PrabalManchanda/Inventory-design',
              'PrabalManchanda/Inventory-Management',
              'PrabalManchanda/ERROR401',
            ],
          },
      },
